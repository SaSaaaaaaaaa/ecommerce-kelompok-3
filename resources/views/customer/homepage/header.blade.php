                            ...
                            <div class="site-navigation">
                                <nav id="main-navigation">
                                    <ul id="menu-main-menu" class="menu">
                                        ...
                                        <li class="level-0 menu-item">
                                            <a href="page-contact.html"><span class="menu-item-text">Wishlist</span></a>
                                        </li>
                                        <li class="level-0 menu-item">
                                            ...
                                            <li class="level-0 menu-item">                                   
                                                ...
                                                document.getElementById('logout-form').submit();"><span class="menu-item-text">{{ __('Logout') }}</span></a>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-12 col-sm-12 col-12 header-right">
                            <div class="header-page-link">
                                ...
                                <div class="login-header icon">
                                    <a class="menu-item-text" href="#"><i class="icon-user"> Hello, <strong>{{ Auth::user()->name }}</strong></i></a>
                                </div>
