    ...
    <div id="title" class="page-title">
        <div class="section-container">
            ...
            <div class="breadcrumbs">
                <a href="{{route('homepage')}}">Home</a><span class="delimiter"></span>Easy Fixes for Home Decor
            </div>
        </div>
    </div>
        ...
        <div class="section-padding">
            <div class="section-container p-l-r">
                <div class="post-details no-sidebar">
                    ...
                    <div class="post-meta">
                        <span class="post-categories"><i class="icon_folder-alt"></i> <a href="{{route('blog')}}">Furniture</a></span>
                    ...
                    <div class="post-content-entry">
                        <div class="tags-links">
                            <label>Tags :</label> <a href="{{route('blog')}}" rel="tag">Baby Needs</a>
                        </div>
