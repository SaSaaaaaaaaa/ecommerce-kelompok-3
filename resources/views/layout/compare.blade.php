                    ...
                    <table id="product-table" class="product-table">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <a href="{{route('item')}}">Chair Oak Matt Lacquered</a> <span class="remove">remove</span>
                                </th>
                                <th>
                                    <a href="{{route('item')}}">Zunkel Schwarz</a> <span class="remove">remove</span>
                                </th>
                                <th>
                                    <a href="{{route('item')}}">Namaste Vase</a> <span class="remove">remove</span>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
