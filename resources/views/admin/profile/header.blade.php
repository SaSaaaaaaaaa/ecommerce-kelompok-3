            ...
            <div class="relative w-[70%] flex justify-end items-center" x-data="{ userOption: false }">
                ...
                >
                    <div class="flex items-center space-x-3 border-b border-gray pb-3 mb-2">
                        ...
                        <div class="">
                            <h5 class="text-base mb-1 leading-none">{{ Auth::user()->name }}</h5>
                            <p class="mb-0 text-tiny leading-none"><a href="https://weblearnbd.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="c9baa1a8a1a7acbea8b389a4a8a0a5e7aaa6a4">[email&#160;protected]</a></p>
                        </div>
                    </div>
                    <ul>
                        <li>
                            <a href="{{route('admin-dashboard')}}" class="px-5 py-2 w-full block hover:bg-gray rounded-md hover:text-theme text-base">Dashboard</a>
                        </li>
                        <li>
                            <a href="{{route('admin-profile')}}" class="px-5 py-2 w-full block hover:bg-gray rounded-md hover:text-theme text-base">
                                Account Settings
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('logout') }}" onclick="event.preventDefault();
                            document.getElementById('logout-form').submit();"><span class="px-5 py-2 w-full block hover:bg-gray rounded-md hover:text-theme text-base">{{ __('Logout') }}</span></a>
