            ...
            <div class="relative w-[70%] flex justify-end items-center" x-data="{ userOption: false }">
                ...
                >
                    <div class="flex items-center space-x-3 border-b border-gray pb-3 mb-2">
                        ...
                        <div class="">
                            <h5 class="text-base mb-1 leading-none"><strong>{{ Auth::user()->name }}</strong></h5>
                            <p class="mb-0 text-tiny leading-none">{{ Auth::user()->email }}</a></p>
                        </div>
                    </div>
                    <ul>
                        <li>
                            <a href="index-2.html" class="px-5 py-2 w-full block hover:bg-gray rounded-md hover:text-theme text-base">Dashboard</a>
                        </li>
                        <li>
