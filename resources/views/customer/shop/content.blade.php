    ...
    <div id="title" class="page-title">
        <div class="section-container">
            ...
            <div class="breadcrumbs">
                <a href="{{route('homepage')}}">Home</a><span class="delimiter"></span><a href="{{route('shop')}}">Shop</a><span class="delimiter"></span>Bed &amp; Bath
            </div>
        </div>
    </div>
                        ...
                        <div class="block block-product-cats">
                            ...
                            <div class="block-content">
                                <div class="product-cats-list">
                                    <ul>
                                        <li class="current">
                                            <a href="{{route('shop')}}">Bed & Bath <span class="count">9</span></a>
                                        </li>
                                        <li>
                                            <a href="{{route('shop')}}">Furniture <span class="count">4</span></a>
                                        </li>
                                        <li>
                                            <a href="{{route('shop')}}">Home Décor <span class="count">3</span></a>
                                        </li>
                                        <li>
                                            <a href="{{route('shop')}}">Lighting <span class="count">6</span></a>
                                        </li>
                                        <li>
                                            <a href="{{route('shop')}}">Office <span class="count">2</span></a>
                                        </li>
                                        <li>
                                            <a href="{{route('shop')}}">Outdoor <span class="count">4</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="block-content">
                                <ul class="products-list">
                                    <li class="product-item">
                                        <a href="{{route('item')}}" class="product-image">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="products-entry clearfix product-wapper">
                                                ...
                                                <div class="products-content">
                                                    <div class="contents text-center">
                                                        <h3 class="product-title"><a href="{{route('item')}}">Dining Table</a></h3>
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                            <div class="products-entry clearfix product-wapper">
                                                ...
                                                <div class="products-content">
                                                    <div class="contents text-center">
                                                        <h3 class="product-title"><a href="{{route('item')}}">Mags Sofa 2.5 Seater</a></h3>
                                                        <span class="price">$150.00</span>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                            <div class="products-entry clearfix product-wapper">
                                                ...
                                                <div class="products-content">
                                                    <div class="contents text-center">
                                                        <h3 class="product-title"><a href="{{route('item')}}">Spinning pendant lamp</a></h3>
                                                        <span class="price">
                                                            <del aria-hidden="true"><span>$150.00</span></del> 
                                                            <ins><span>$100.00</span></ins>
                                                        </span>
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                            <div class="products-entry clearfix product-wapper">
                                                ...
                                                <div class="products-content">
                                                    <div class="contents text-center">
                                                        <h3 class="product-title"><a href="{{route('item')}}">Bora Armchair</a></h3>
                                                        <span class="price">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                            <div class="products-entry clearfix product-wapper">
                                                ...
                                                <div class="products-content">
                                                    <div class="contents text-center">
                                                        <h3 class="product-title"><a href="{{route('item')}}">Panton Dining Table</a></h3>
                                                        <span class="price">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                            <div class="products-entry clearfix product-wapper">
                                                ...
                                                <div class="products-content">
                                                    <div class="contents text-center">
                                                        <h3 class="product-title"><a href="{{route('item')}}">Kittchen Table</a></h3>
                                                        <span class="price">$120.00</span>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                            <div class="products-entry clearfix product-wapper">
                                                ...
                                                <div class="products-content">
                                                    <div class="contents text-center">
                                                        <h3 class="product-title"><a href="{{route('item')}}">Mundo Sofa With Cushion</a></h3>
                                                        <span class="price">
                                                            <del aria-hidden="true"><span>$200.00</span></del> 
                                                            <ins><span>$180.00</span></ins>
                                                        </span>
