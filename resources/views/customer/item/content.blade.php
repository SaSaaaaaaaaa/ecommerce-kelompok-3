    ...
    <div id="title" class="page-title">
        <div class="section-container">
            ...
            <div class="breadcrumbs">
                <a href="{{route('homepage')}}">Home</a><span class="delimiter"></span><a href="{{route('shop')}}">Shop</a><span class="delimiter"></span>Bora Armchair
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="product-info col-lg-5 col-md-12 col-12 ">
                                ...
                                <div class="product-meta">
                                    ...
                                    <span class="posted-in">Category: <a href="{{route('shop')}}" rel="tag">Furniture</a></span>
                                    <span class="tagged-as">Tags: <a href="{{route('shop')}}" rel="tag">Hot</a>, <a href="{{route('shop')}}" rel="tag">Trend</a></span>
                                </div>
